    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/webhooks/**").permitAll() // Razorpay webhooks
                        ...
                        // Customer endpoints
                        .requestMatchers("/api/bookings/**").hasAnyRole("CUSTOMER", "ORGANIZER", "ADMIN")
                        .requestMatchers("/api/tickets/**").hasAnyRole("CUSTOMER", "ORGANIZER", "ADMIN")
                        .requestMatchers("/api/payments/**").hasAnyRole("CUSTOMER", "ORGANIZER", "ADMIN")
